...
if (isset($_POST['ChangeProfile'])) {
  ...
  $Qry = "UPDATE admins SET admin_name =?, admin_email =? WHERE admin_id =?";
        ...
        <div class="container-fluid d-flex align-items-center">
          <div class="row">
            <div class="col-lg-7 col-md-10">
              <h1 class="display-2 text-white">Benvenuto <?php echo $admin->admin_name; ?></h1>
              <p class="text-white mt-0 mb-5">Questa è la pagina del tuo profilo. Puoi personalizzare il tuo profilo come desideri e anche cambiare la password</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-xl-8 order-xl-1">
            <div class="card bg-secondary shadow">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="form-control-label" for="input-username">Nome Utente</label>
              ...
              <hr>
              <form method =" post">
                            <h6 class="heading-small text-muted mb-4">Cambio password</h6>
                            <div class="pl-lg-4">
                              <div class="row">
                                <div class="col-lg-12">
                                  <div class="form-group">
                                    <label class="form-control-label" for="input-username">Vecchia Password</label>
                                ...
                                <div class="col-lg-12">
                                  <div class="form-group">
                                    <label class="form-control-label" for="input-email">Nuova Password</label>
                                ...
                                <div class="col-lg-12">
                                  <div class="form-group">
                                    <label class="form-control-label" for="input-email">Conferma Nuova Password</label>
